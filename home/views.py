...
def cube(request, number):
    ...
    return render(request, 'home/cube.html' , {'cube_num':cube_num})
...
def template_example(request):
    ...
    return render(request, 'home/template_example.html', {'my_list' :my_list, 'my_sentence':my_sentence, 'messages' : messages,
    'empty_list' : empty_list, 'datetime_now':datetime_now})
    
    
def static_exaple(request):
    return render(request, "home/static_exaple.html")
